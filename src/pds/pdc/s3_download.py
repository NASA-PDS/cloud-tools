...
def main():
    ...
    parser.add_argument("--source-profile", default=default_source_profile,
                        help=("AWS profile name for the source bucket "
                              "(defaults to AWS_PROFILE environment variable)"))
    parser.add_argument("--source-bucket", default=default_source_bucket,
                        help=("Name of the source S3 bucket "
                              "(defaults to AWS_BUCKET environment variable)"))
    parser.add_argument("--source-prefix", required=True,
                        help="Prefix in the source bucket to filter objects")
    parser.add_argument("--local-dest-dir", required=True,
